...
const ExcelUpload = ({ children }: any) => {
            ...
            <div className="flex min-h-full items-end justify-center p-0 text-center sm:items-center sm:p-0">
              ...
              >
                <Dialog.Panel className="relative transform overflow-hidden sm:rounded-lg text-left shadow-xl transition-all my-0 h-screen sm:h-fit sm:my-8 w-screen sm:w-full sm:max-w-lg">
                  ...
                  {excelFormat ? <div className="h-full relative z-8" aria-labelledby="modal-title" role="dialog" aria-modal="true">
 ...
 <h3 className="text-lg font-medium leading-6 text-gray-900" id="modal-title">Excel Format Required*</h3>
              <button onClick={()=>{setExcelFormat(!excelFormat)}} type="button" className="inline-flex w-full justify-center rounded-full border border-transparent bg-red-600 p-1 text-base font-medium text-white shadow-sm hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 sm:ml-3 sm:w-auto sm:text-sm">X</button>
