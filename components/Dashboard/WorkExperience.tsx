...
const WorkExperience = () => {
	...
	const getProfileData = async () => {
		const response = await axios.get(
			"http://localhost:5000/filter/student/19IT1024",
			{
				headers: {
		...
		<div className="w-full sm:w-11/12 mx-auto  flex flex-col items-center justify-around bg-slate-200 sm:bg-white container rounded-lg">
				...
				(
					...
					<div className="flex flex-col items-center mx-auto mb-3 w-11/12 p-2 bg-white border-2 border-neutral-300 rounded-md">
						<div className="w-11/12">
							...
							<h2 className="text-left mb-3 text-sm sm:text-base text-slate-700 font-medium">
								Company Name
							</h2>
							<input
								type="text"
								...
								className="mb-3 mx-auto w-full bg-white border-gray-300 border-solid border-2 rounded-mg text-black py-1 px-1 rounded-md"
							></input>
						</div>
						<div className="w-11/12">
							<h2 className="text-left mb-3 text-sm sm:text-base text-slate-700 font-medium">
						...
						<div className="w-11/12">
							<div className="flex mx-auto flex-col sm:flex-row w-full justify-around items-center">
								<h2 className="text-sm sm:text-base text-slate-700 font-medium">
									Start Month
								</h2>
								<input
									type="month"
									...
									className=" mx-auto w-full md:w-4/12 bg-white border-gray-300 border-solid border-2 rounded-mg text-black py-1 px-1 rounded-md"
								></input>
								<h2 className="text-sm sm:text-base text-slate-700 font-medium">
									End Month
								</h2>
						...
						<button
							...
							className="py-2 px-8 rounded-md mt-8 mb-4 bg-accent text-white"
						>
							Save
						</button>
					</div>
			...
			{WorkExperience.length < 3 - workExps.length ? (
				<div className="flex w-11/12 justify-end">
					<button
						className="p-2 px-5 flex gap-2 rounded-md bg-green-600 text-white"
						onClick={() => {
