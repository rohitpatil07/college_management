			...
			<div className="flex flex-col bg-white pb-24">
				...
				{editProf ? (
					<div className="flex flex-col w-full">
						<Link href="/tpc/editProfile/personalInfo">
							<div className="px-8 py-2 font-medium hover:bg-blue-100 active:bg-blue-100">
								Personal Info
							</div>
						</Link>
						<Link href="/tpc/editProfile/academicDetails">
							<div className="px-8 py-2 font-medium hover:bg-blue-100 active:bg-blue-100">
								Academic Details
							</div>
						</Link>
						<Link href="/tpc/editProfile/workExperience">
							<div className="px-8 py-2 font-medium hover:bg-blue-100 active:bg-blue-100">
								Work Experience
							</div>
						</Link>
						<Link href="/tpc/editProfile/project">
							<div className="px-8 py-2 font-medium hover:bg-blue-100 active:bg-blue-100">
								Projects
							</div>
						</Link>
						<Link href="/tpc/editProfile/offerDetails">
							<div className="px-8 py-2 font-medium hover:bg-blue-100 active:bg-blue-100">
								Offer Details
							</div>
						</Link>
						<Link href="/tpc/editProfile/additionalInfo">
							<div className="px-8 py-2 font-medium hover:bg-blue-100 active:bg-blue-100">
								Additional Info
							</div>
						</Link>
						<Link href="/tpc/editProfile/changePassword">
							<div className="px-8 py-2 font-medium hover:bg-blue-100 active:bg-blue-100">
								Change Password
							</div>
						</Link>
