...
const ViewForum = ({
  ...
  const postComment = async () => {
    const comm = {
      ...
      first_name:`${AuthData.user.userData.user.first_name}`,
      last_name:`${AuthData.user.userData.user.last_name}`,
  ...
  return (
    <div className="w-full sm:w-11/12 mx-auto flex flex-col items-center justify-around container">
      ...
      {forumMessages && <Thread forumMessages={forumMessages} auth={AuthData}/>}
