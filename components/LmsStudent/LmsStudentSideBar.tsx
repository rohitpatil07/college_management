...
const LmsStudentSideBar = () => {
  return (
    <aside className="hidden sm:flex flex-col bg-white min-h-screen h-inherit sm:2/5 md:w-1/5 text-slate-500">
      ...
      <Link
        href="#"
        className="flex flex-row px-2 py-2 items-center font-medium border-t border-t-slate-500 hover:bg-blue-100 active:bg-blue-100"
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 20 20"
...
export default LmsStudentSideBar;
