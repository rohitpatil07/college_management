...
const Profile = () => {
  ...
  const [link_two, setLinkTwo] = useState("");
  ...
  const fetchDrive = async () => {
    console.log(AuthData.user.userData.user.company_name);
    try {
                            ...
                            >
                              <div className="relative top-0 left-0 flex h-full w-full flex-col justify-between bg-black bg-opacity-75 p-8">
                                ...
                                <p className="mb-2 text-xs text-base text-gray-300 text-center">
                                  ...
                                  adipiscing elit. Sed tincidunt, erat in
                                  malesuada aliquam, est erat faucibus purus,
